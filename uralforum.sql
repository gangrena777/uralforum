...
--
-- Хост: mysql
-- Время создания: Окт 04 2023 г., 14:42
...
(10, 'не согласен с вами', 20, '2023-09-30 10:30:00', 13),
(11, 'с чем именно?', 2, '2023-09-30 10:00:00', 13),
...
(40, 'какие ваши любимые фильмы', 22, '2023-10-03 21:57:09', 42),
(41, '123456789', 23, '2023-10-04 17:34:52', 11),
(42, '1234567890йффяцыч', 23, '2023-10-04 17:38:58', 11),
(43, 'ЯЯЯЯЯЯЯЧЧЧЧЧЧ', 23, '2023-10-04 17:39:13', 11),
(44, 'что за хренеь ты пишешь', 2, '2023-10-04 17:41:28', 11);
...
ALTER TABLE `authors`
  ADD PRIMARY KEY (`id`),
  ADD KEY `author_name_2` (`author_name`,`date_register`);
...
ALTER TABLE `posts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `date_create_post` (`date_create_post`),
  ADD KEY `date_create_post_2` (`date_create_post`),
...
ALTER TABLE `post_category`
  ...
  ADD KEY `author_cat_id` (`author_cat_id`);
